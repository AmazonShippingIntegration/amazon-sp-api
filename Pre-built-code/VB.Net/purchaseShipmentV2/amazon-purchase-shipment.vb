...
Public Class cls_LDV_AMZ
    ...
    Public Sub purchaseShipment()
        Dim client = New RestClient("https:" & "sandbox.sellingpartnerapi-eu.amazon.com/shipping/v2/shipments")
        ...
        body = "{""requestToken"": ""amzn1.987c52ea-898a-4ce6-a11e-23344cdd0db7"",""rateId"":""e9305a93989acce639f625842b64708f9daaf73bb87cc0cbf11f31f3c944b9761507200580943"",""requestedDocumentSpecification"": {""format"": ""PDF"",""size"": {""width"": 4,""length"": 6,""unit"": ""INCH""},""dpi"": 203,""pageLayout"": ""DEFAULT"",""needFileJoining"": false,""requestedDocumentTypes"": [""LABEL""]}}"
        ...
        canonicalRequest &= "/shipping/v2/shipments" & vbLf         'CanonicalURI 
