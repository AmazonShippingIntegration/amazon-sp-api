...
//https://sellingpartnerapi-eu.amazon.com/shipping/v2/tracking?trackingId=$trackingId&carrierId=AMZN_UK
...
$response = '{
	...
	/*processing getTracking api starts here*/
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'https://sellingpartnerapi-eu.amazon.com/shipping/v2/tracking?trackingId=$trackingId&carrierId=AMZN_UK',
...
$region             = "eu-west-1";
$service            = "execute-api";
$requestUrl         = "https://sellingpartnerapi-eu.amazon.com/shipping/v2/tracking?trackingId=$trackingId&carrierId=AMZN_UK";
$uri                = '/shipping/v2/tracking';
...
$debug              = FALSE;
    ...
    $phpAlgorithm       = 'sha256';
    $canonicalURI       = $uri;
    $canonicalQueryString   = 'carrierId=AMZN_IT&trackingId=$trackingId';  //for Tracking Value of CanonicalQueryString should be this -> carrierId=AMZN_IT&trackingId=$trackingId
    ...
    $headers[] = 'x-amzn-shipping-business-id=AmazonShipping_UK';
